...
public class IHMQuestion2_2 extends JFrame {
    ...
    public IHMQuestion2_2() {
        ...
        jmo1 = new JMouseObserver("Observateur jmo1: souris entr?e en : ", contenu);
        jmo2 = new JMouseObserver("Observateur jmo1: souris entr?e en : ", contenu);
        jmo3 = new JMouseObserver("Observateur jmo1: souris entr?e en : ", contenu);

        // à complé?ter à l'identique de la question 2_1, (du copier/coller)...
        ...
        // à complé?ter pour la question 2_2 (JMouseObserver)
